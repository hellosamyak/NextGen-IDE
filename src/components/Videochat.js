...
//         <video ref={userVideo} autoPlay playsInline className="w-full h-auto rounded-lg shadow-lg" muted={isMuted} />
//         <div className="mt-2">
//           <button onClick={toggleMute} className="mr-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
//             {isMuted ? 'Unmute Audio' : 'Mute Audio'}
//           </button>
//           <button onClick={toggleCamera} className="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">
...
//         <div className="flex flex-wrap">
//           {peers.map(peer => (
//             <div key={peer.peerID} className="w-full sm:w-1/2 p-2">
...
//         <pre className="bg-gray-100 p-4 rounded-lg shadow-lg overflow-auto">{sharedCode}</pre>
//         <button onClick={downloadSharedCode} className="mt-2 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">
...
//   return <video ref={ref} autoPlay playsInline className="w-full h-auto rounded-lg shadow-lg mb-4" />;
// };
